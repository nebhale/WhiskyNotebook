...
final class ArrayDramDataSourceSpec: QuickSpec {
    override func spec() {
        let storyboard = UIStoryboard(name: "WhiskyNotebook", bundle: NSBundle(forClass: self.dynamicType))

        describe("ArrayDramDataSource") {
            var dataSource: ArrayDramDataSource!
            ...
            beforeEach {
                ...
                dataSource = ArrayDramDataSource(repository: repository, scheduler: scheduler)
