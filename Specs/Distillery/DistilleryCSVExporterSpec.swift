...
final class DistilleryCSVExporterSpec: QuickSpec {
    override func spec() {
        describe("DistilleryCSVExporter") {
            var exporter: DistilleryCSVExporter!
            ...
            beforeEach {
                ...
                exporter = DistilleryCSVExporter(repository: repository, scheduler: scheduler, viewController: rootViewController)
            }
